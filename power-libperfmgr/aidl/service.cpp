...
int main() {
    LOG(INFO) << "Xiaomi msm8996 Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "Xiaomi msm8996 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Xiaomi msm8996 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
